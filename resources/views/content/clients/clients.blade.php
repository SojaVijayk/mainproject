                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="salesByCountryTabs">
                                ...
                                <a href="javascript:;" data-bs-toggle="modal" data-id={{ $client->id }}
                                    ...
                                    <a  data-id={{ $client->id }} class=" dropdown-item client-contact-modal create-contact"><span>Add Contact Person</span></a>
                    ...
                    <div class="card-body">
                        <div class="nav-align-top">
                            <ul class="nav nav-tabs nav-fill" role="tablist">
                                <li class="nav-item">
                                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                        data-bs-target="#navs-justified-link-about{{ $client->id }}"
                            ...
                            <div class="tab-content pb-0">
                                ...
                                <div class="tab-pane fade active show" id="navs-justified-link-about{{ $client->id }}"
                                    role="tabpanel">
                                    {{ $client->client_name }}
                                ...
                                <div class="tab-pane fade" id="navs-justified-link-project{{ $client->id }}"
                                    role="tabpanel">
                                            ...
                                            <li class="timeline-item ps-4 border-left-dashed">
                                                ...
                                                <div class="timeline-event ps-0 pb-0">
                                                    <div class="timeline-header">
                                                        <small
                                                            class="text-success text-uppercase fw-semibold">{{ $value->project_name }}</small>
                                                    </div>
                                ...
                                <div class="tab-pane fade " id="navs-justified-link-contact{{ $client->id }}"
                                    role="tabpanel">
                                    <ul class="timeline timeline-advance mb-2 pb-1">
                                        <li class="timeline-item ps-4 border-left-dashed">
                                            <span class="timeline-indicator timeline-indicator-success">
                                            ...
                                            <div class="timeline-event ps-0 pb-0">
                                                <div class="timeline-header">
                                                    <small
                                                        class="text-primary text-uppercase fw-semibold">{{ $client->address }}</small>
                                                </div>
                                        ...
                                        @foreach ($client->contactPersons as $person)
                                            <li class="timeline-item ps-4 border-left-dashed">
                                                ...
                                                <div class="timeline-event ps-0 pb-0">
                                                    <div class="timeline-header">
                                                        <small
                                                            class="text-primary text-uppercase fw-semibold">{{ $person->name }}
                                                            - ({{ $person->designation }})</small>
                                                            <span class="float-end">
                                                              <button data-id="{{ $person->id }}" class="btn btn-outline-warning btn-sm my-sm-0 my-3 edit-contact">
                                                                Edit
                                                              </button>
                                                             </span>
                                                    </div>
