...
<div class="  text-center mb-2">
  <button data-bs-target="#addClientModal" data-bs-toggle="modal" class="btn btn-primary mb-2 text-nowrap add-new-client">Add New Client</button>
      ...
      <div class="card-header d-flex justify-content-between pb-2 mb-1">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end" aria-labelledby="salesByCountryTabs">
            ...
            <a href="javascript:;" data-bs-toggle="modal"  data-id={{$client->id}} data-bs-target="#addClientModal" class=" dropdown-item client-edit-modal edit-record"><span>Edit Client</span></a>
      ...
      <div class="card-body">
        <div class="nav-align-top">
          <ul class="nav nav-tabs nav-fill" role="tablist">
            <li class="nav-item">
              <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-justified-link-about{{$client->id}}" aria-controls="navs-justified-link-about" aria-selected="false">About</button>
            </li>
            <li class="nav-item">
              <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-justified-link-project{{$client->id}}" aria-controls="navs-justified-link-project" aria-selected="false">Projects</button>
            </li>
            <li class="nav-item">
              <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-justified-link-contact{{$client->id}}" aria-controls="navs-justified-link-contact" aria-selected="false">Contacts</button>
            </li>
          </ul>
            ...
            <div class="tab-pane fade " id="navs-justified-link-contact{{$client->id}}" role="tabpanel">
              <ul class="timeline timeline-advance mb-2 pb-1">
                <li class="timeline-item ps-4 border-left-dashed">
                  ...
                  <div class="timeline-event ps-0 pb-0">
                    <div class="timeline-header">
                      <small class="text-success text-uppercase fw-semibold">{{$client->address}}</small>
                    </div>
