...
$(function () {
  ...
  var dt_user_table = $('.datatables-users'),userView,select2,statusObj, offCanvasForm = $('#offcanvasAddUser'),dt_user,
    ...
    <div class="offcanvas-body mx-0 flex-grow-0 pt-0 h-100">
      <form class="add-new-user pt-0" id="addNewUserForm" onsubmit="return false">
        ...
        <div class="mb-3 ">
          ...
          <input type="text" class="form-control datepicker" id="doj" name="doj" placeholder="MM/DD/YYYY" class="form-control" />
                  ...
                  <div id="contact-details-vertical" class="content">
                    ...
                    <div class="row g-3">
                      <div class="col-sm-6">
                        ...
                        <input type="text" id="username1" class="form-control" placeholder="j" />
                      </div>
                      <div class="col-sm-6">
                  ...
                  <div id="account-details-vertical" class="content">
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-sm-6">
                        ...
                        <input type="text" id="email1" class="form-control" placeholder="j" aria-label="" />
                      </div>
                      <div class="col-sm-6">
