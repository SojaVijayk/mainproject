...
<div class="row g-4">
  ...
  <div class="card h-100 col-md-6 col-lg-4 col-xl-4 mb-4">
    ...
    <div class="card-body">
        ...
        <div class="nav-align-top pt-2">
          <ul class="nav nav-pills mb-3" role="tablist">
            ...
            <li class="nav-item">
              <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-top-manage{{$project->id}}" aria-controls="navs-pills-top-messages" aria-selected="false">Manage</button>
            </li>
          </ul>
