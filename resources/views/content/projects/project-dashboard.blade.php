...
@section('page-script')
    ...
    <script>
      ...
      $(document).on('click', '.milestone-task', function(e) {


        $('.task-btn').trigger('click');
        $('#milestone_filter').val($(this).data('id'));
        $('#milestone_filter').trigger('change');


      });
        $(document).on('click', '#submit_milestone', function(e) {
            ...
            if (type == 'new') {
                $.ajax({
                    url: `${baseUrl}project/milestone/store`,
                    type: 'POST',
                    data: {
                    ...
                    success: function(status) {
                        ...
                        Swal.fire({
                            ...
                            text: `Project Milestone ${status} Successfully.`,
                            customClass: {
                ...
                $.ajax({
                    url: `${baseUrl}project/milestone//update/${milestone_id}`,
                    type: 'POST',
                    data: {
...
<div class="faq-header d-flex flex-column justify-content-center align-items-center rounded ">
  <h3 class="text-center text-white"> Project : {{ $project_details->project_name }} - Project ID : <span class="text-bold"> #{{ $project_details->id.'/'.date('Y') }} </span></h3>
    ...
    <p class="text-center text-white mb-0 px-3">
      <h6 class="mb-0 p-2 text-white">Start Date: <span class="text-white fw-normal">{{$project_details->expected_start_date}}</span>
    ...
    <div class="d-flex  align-items-center pt-1 text-white">
      ...
      {{--  <div class="ms-auto">
        <a href="javascript:void(0);" class="text-white"><i class="ti ti-message-dots ti-sm"></i> {{count($project_details->leads)}}</a>
      </div>  --}}
      <div class="d-flex align-items-center p-2">
        <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 zindex-2 mt-1">
                ...
                <div class="card-header">
                    <div class="divider">
                        <div class="divider-text">
                            <h5 class="card-title text-white"><small>Project</small> : {{ $project_details->project_name }} - <small>Project ID</small> : <span class="text-bold"> #{{ $project_details->id.'/'.date('Y') }} </span></h5>
                        </div>
            ...
            <ul class="nav nav-pills card-header-pills nav-fill" role="tablist">
                ...
                <li class="nav-item">
                    <button type="button" class="nav-link" data-bs-toggle="tab"
                        data-bs-target="#navs-pills-within-card-link" role="tab">Baseline/Milestone</button>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <button type="button" class="nav-link" data-bs-toggle="tab"
                        data-bs-target="#navs-pills-file" role="tab">Files</button>
                </li>
                <li class="nav-item">
                    <button type="button" class="nav-link" data-bs-toggle="tab"
                        data-bs-target="#navs-pills-financial" role="tab">Financial</button>
                </li>
                <li class="nav-item">
                    <button type="button" class="nav-link" data-bs-toggle="tab"
                        data-bs-target="#navs-pills-more" role="tab">Moe</button>
                </li>
                ...
                <div class="tab-pane fade" id="navs-pills-within-card-link" role="tabpanel">
                    ...
                    <div class="row" id="sortable-4">
                        ...
                        @foreach ($project_details->milestone as $item)
                            @php
                                $array = ['text-white bg-primary', 'text-white bg-success', 'text-white bg-secondary', 'text-white bg-danger', 'text-white bg-warning'];
                              ...
                              <div class="card h-100">
                                ...
                                <div class="card-body pt-1">
                                  ...
                                  <div class="text-center align-items-center  mb-2">
                                    ...
                                    <button type="button" class=" btn-sm btn btn-success milestone-task"
                                           data-id="{{ $item->id }}">View Task</button>
