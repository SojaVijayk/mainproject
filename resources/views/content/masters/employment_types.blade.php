        ...
        $(function() {
                ...
                dt_permission = dataTablePermissions.DataTable({
                    ...
                    columnDefs: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                return (
                                    '<span class="text-nowrap"><button class="btn btn-sm btn-icon me-2 edit-employment_type" data-id="' +
                                    full['id'] +
                                    '" data-bs-target="#EmploymentTypeModal" data-bs-toggle="modal" data-bs-dismiss="modal"><i class="ti ti-edit"></i></button>' +
            ...
            (function() {
                ...
                var designationEditList = document.querySelectorAll(
                        '.datatables-employment .edit-employment-type'),
