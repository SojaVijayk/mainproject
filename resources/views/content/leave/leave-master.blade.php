...
$(function () {
  ...
  var dataTablePermissions = $('.datatables-leave'),
    dt_permission,
    permissionList = baseUrl + 'leave/list';
...
(function () {
  ...
  var leaveEditList = document.querySelectorAll('.datatables-leave .edit-leave'),
   ...
   var  modalLeaveName =  $("#modalLeaveName").val();

   var type =   $("#submit_leave").data('type');
   var desig_id =   $("#submit_leave").data('id');
   if(type=='new'){
      $.ajax({
        data:  {
...
@section('content')
<h4 class="fw-semibold mb-4">Leave List</h4>
