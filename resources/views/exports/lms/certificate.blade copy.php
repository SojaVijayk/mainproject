...
.nameText{
    ...
    <body>
        ...
        <div>
                ...
                <div style="width:100%; margin:0; padding-top:22em;" class="cer_text">
                  ...
                  <tr>
                                  <td align="center" width="28%" valign="bottom" style="padding-bottom: 1em; " >
                                    ...
                                    <hr style="color: #d7a534">
                                     <p style=" padding:0px;margin:0px; font-weight:600;">No: CMD/SSK/{{date('Y')}}-0001 <br><small style="color:#737373">Generated on {{ date('Y-m-d H:i:s') }}</small></p>
                                      </td>
