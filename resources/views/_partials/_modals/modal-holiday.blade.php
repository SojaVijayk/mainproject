    ...
    <div class="modal-content p-3 p-md-5">
      ...
      <div class="modal-body">
        <div class="text-center mb-4">
          <h3 class="mb-2 employment-title">Add New Holiday</h3>
        ...
        <form id="EmploymentTypeForm" class="row" onsubmit="return false">
          <div class="col-12 mb-3">
            ...
            <input type="text" id="date" name="date" class="form-control datepicker" placeholder="Date" autofocus />
          </div>
          <div class="col-12 mb-3">
            <label class="form-label" for="description">Description</label>
            <input type="text" id="description" name="description" class="form-control" placeholder="description" autofocus />
          </div>
