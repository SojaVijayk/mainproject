...
@section('content')
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Assets / Locations /</span> Edit
</h4>
...
<div class="card">
  ...
  <div class="card-body">
    <form action="{{ route('asset.locations.update', $location->id) }}" method="POST">
      @csrf
      @method('PUT')
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" id="address" name="address" rows="3">{{ $location->address }}</textarea>
      </div>
